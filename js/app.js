    ...
    fetchData(URL.currentWeather(lat, lon), function (currentWeather) {
        ...
        card.innerHTML = `
                <h2 class="title-2 card-title">Now</h2>
                        ...
                        <div class="weapper">
                            ...
                            <p class="heading">${parseInt(temp)}&deg;<sup>c</sup>
                            </p>

                            <img src="./images/weather_icons/${icon}.svg" width="120" height="120" alt="${description}" class="weather-icon">
        ...
        fetchData(URL.forecast(lat, lon), function (forecast) {
            ...
            for (const [index, data] of forecastList.entries()) {
                ...
                tempLi.innerHTML = `
                <div class="card card-sm slier-card">

                                    <p class="body-3">${module.getHours(dateTimeUnix, timezone)}</p>

                                    <img src="./images/weather_icons/${icon}.svg" width="70" height="70" loading="lazy"
                ...
                windLi.innerHTML = `
                    <div class="card card-sm slider-card">
                        ...
                        <img src="./images/weather_icons/direction.svg" width="52" height="52"
            ...
            container.style.oberflowY = "overlay";
